  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 font-inter">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-3/4 right-1/4 w-80 h-80 bg-gradient-to-r from-blue-400/20 to-cyan-400/20 rounded-full blur-3xl floating-animation"
              ...
              {[
                {
                  icon: "🎯",
                  title: "High Accuracy",
                  desc: "State-of-the-art AI transcription",
                },
                {
                  icon: "🌍",
                  title: "Protection",
                  desc: "Protects privacy and data",
                },
                {
                  icon: "⚡",
                  title: "Real-time",
                  desc: "Instant transcription results",
                },
              ].map((feature, index) => (
                <div
                  key={index}
